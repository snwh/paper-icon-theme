...
MAINDIR = '../Paper'
SOURCES = ('bitmaps/apps', 'bitmaps/categories', 'bitmaps/devices', 'bitmaps/games', 'bitmaps/logos', 'bitmaps/mimetypes', 'bitmaps/places', 'bitmaps/preferences', 'bitmaps/status', 'bitmaps/third-party', 'bitmaps/web')
# SRC = 'bitmaps'
